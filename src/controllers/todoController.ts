...
import { addTodo, getTodosByCollection, updateTodo, deleteTodo } from '../services/todoService';
...
export async function list(req: Request, res: Response) {
  const { collectionId } = req.params;
  const { success, error, databaseCreated, dbId, pageCreated, pageId } = req.query;
